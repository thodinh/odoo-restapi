# Odoo REST API
"This module exposes Odoo as a REST API, adapted from the [yezyilomo/odoo-rest-api](https://github.com/yezyilomo/odoo-rest-api) project. It has been modified to support authentication compatible with Odoo API Keys."

## Getting Started

### Authenticating users
1. Generate API in Odoo Preferences > Account Security > API KEYS

![Generate API in Odoo](https://f003.backblazeb2.com/file/digiforce/2024/11/brave_dl9US2TJTV.png)

2. Add header `Authorization: <API key generated from Odoo>` to request API
